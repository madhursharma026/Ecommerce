                ...
                <div class="card-body py-lg-5 text-center px-5">
                    ...
                    <div className="row pt-4">
                        <div className="col-lg-6" style={{ textAlign: "left" }}>
                            <h5>SATISH</h5>
                            <h6 className="text-muted">BANGALORE,INDIA</h6>
                        </div>
                        <div className="col-lg-6 verified_lawyer">
                            <h5 className="text-success"><img src="https://cdn.shopify.com/s/files/1/1865/1011/files/rightmark.png?v=1627904599" alt="#ImgNotFound" /> Verified buyer</h5>
                        </div>
                    </div>
                </div>
            </div>
