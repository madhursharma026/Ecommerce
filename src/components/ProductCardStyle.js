...
function ProductCardStyle(props) {
    return (
        <>
            <Link to="/product_page" style={{ textDecoration: "none" }}>
                <div class="card w-100 text-center product_card" style={{ border: "0" }}>
                    <div className="text-center">
                        <img src={props.productImg} class="card-img-top p-5" alt="#ImgNotFound" style={{ maxWidth: "400px", maxHeight: "400px" }} />
                    </div>
