        ...
        <Router>
            <Routes>
                <Route path="/" element={<MainLayout />}>
                    ...
                    <Route path="/product_page/1" element={<><NewProductPageOne /> <title>Buy First Flush Spring Darjeeling Tea online from Teabox. Shop First Flush Spring Tea online &amp; get it shipped, straight from the source. Enjoy a great cup of Tea.</title></>} />
                    <Route path="/product_page/2" element={<><NewProductPageTwo /> <title>Buy First Flush Spring Darjeeling Tea online from Teabox. Shop First Flush Spring Tea online &amp; get it shipped, straight from the source. Enjoy a great cup of Tea.</title></>} />
